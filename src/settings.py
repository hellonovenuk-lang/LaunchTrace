...
class Settings(BaseSettings):
    ...
    ukipo_journal_base_url: str = Field(
        # The journal lives at /t-tmj/tm-journals/<number>/jnl.xml. The older
        # /types/tm/t-os/... path this used to point at 404s, which is half of
        # why every automated fetch failed.
        default="https://www.ipo.gov.uk/t-tmj/tm-journals",

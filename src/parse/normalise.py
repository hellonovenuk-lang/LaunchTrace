...
LEGAL_SUFFIXES = (
    "limited", "ltd", "ltd.", "plc", "p.l.c.", "llp", "l.l.p.", "llc", "lp",
    "cic", "c.i.c.", "cio", "incorporated", "inc", "inc.", "corporation", "corp",
    "corp.", "company", "co", "co.", "gmbh", "bv", "b.v.", "nv", "n.v.", "sarl",
    "s.a.r.l.", "srl", "s.r.l.", "sa", "s.a.", "ag", "as", "a/s", "oy", "ab",
    "aps", "pty", "pte", "sdn bhd", "kk", "kft", "spa", "s.p.a.", "cyf",
    "cyfyngedig", "the",
)
